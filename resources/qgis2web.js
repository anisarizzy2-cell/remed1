...
map.getView().fit([12518657.146420, -885275.201252, 12543788.340690, -872071.490831], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis Jangkauan Rumah Sakit di Kota Batu</h2>';
        return titleElement;
    })(),
